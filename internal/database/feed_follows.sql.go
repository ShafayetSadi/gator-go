...
SELECT feed_follows.id, feed_follows.user_id, feed_follows.feed_id, feed_follows.created_at, feed_follows.updated_at, feeds.name AS feed_name, users.username AS user_username
FROM feed_follows
